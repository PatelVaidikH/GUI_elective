...
v1 = IntVar()
c1 = Checkbutton(window, text='Hotstar', font=('Cambria',15), variable=v1, onvalue=1, offvalue=0)
c1.grid(row=1, column=0, padx=20, pady=10, sticky='W')

v2 = IntVar()
c2 = Checkbutton(window, text='SonyLiv', font=('Cambria',15), variable=v2, onvalue=1, offvalue=0)
c2.grid(row=2, column=0, padx=20, pady=10, sticky='W')

v3 = IntVar()
c3 = Checkbutton(window, text='Zee5', font=('Cambria',15), variable=v3, onvalue=1, offvalue=0)
c3.grid(row=3, column=0, padx=20, pady=10, sticky='W')

v4 = IntVar()
c4 = Checkbutton(window, text='Netflix', font=('Cambria',15), variable=v4, onvalue=1, offvalue=0)
c4.grid(row=4, column=0, padx=20, pady=10, sticky='W')

v5 = IntVar()
c5 = Checkbutton(window, text='Amazon Prime Videos', font=('Cambria',15), variable=v5, onvalue=1, offvalue=0)
c5.grid(row=5, column=0, padx=20, pady=10, sticky='W')

v6 = IntVar()
c6 = Checkbutton(window, text='ShemarooMe', font=('Cambria',15), variable=v6, onvalue=1, offvalue=0)
